...
import { isDynamicSelector } from './utils';
...
export function postcssScopedParser(css, resolveId, options, from, start_mark, end_mark, global) {
...
export function urlReplace(input, re, replacer) {
    let match;
    let remaining = input;
    let rewritten = '';
